...
var ExplorePage = (function () {
    function ExplorePage(navCtrl, navParams, modalCtrl, alertCtrl) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        ...
        /**
         *  Função para aplicar o scroll no content de recomendados
         * @type {(event: any) => any}
         */
        this.doScrollRecommended = (function () {
            /** Verifica se a direção do swipe foi para a direita */
            var scrollItens = __WEBPACK_IMPORTED_MODULE_4_jquery__('li.reccommendation-item');
            __WEBPACK_IMPORTED_MODULE_4_jquery__["each"](scrollItens, function (key, item) {
                console.log(key + ' - ' + __WEBPACK_IMPORTED_MODULE_4_jquery__(item).offset().left);
            });
        });
        this.finishScrollRecommended = (function () {
            var alert = _this.alertCtrl.create({
                title: 'Low battery',
